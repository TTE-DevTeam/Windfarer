...
public abstract class AbstractDirectControlSlot implements ConfigurationSerializable {
    ...
    public abstract boolean onLeftClick(ItemStack itemStack, Player interactor, Craft craft, Action action);
    public abstract boolean onRightClick(ItemStack itemStack, Player interactor, Craft craft, Action action);
